...
syn match   pythonDecoratorName    '\%([^[:cntrl:][:space:][:punct:][:digit:]]\|_\)\%([^[:cntrl:][:punct:][:space:]]\|_\)*' display contained
...
"    endif
    ...
    HiLink pythonDecoratorName    Decorator
    ...
    HiLink pythonClass            pyClass
    HiLink pythonClassVar         pyClassVar
